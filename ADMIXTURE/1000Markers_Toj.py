...
data_q =  "C:\\Users\\carol\\Downloads\\q_example_marker_bad.txt" # Filepath
data_p =  "C:\\Users\\carol\\Downloads\\p_bad.txt" # Filepath


data_p = pd.read_csv(data_p, sep = '\t', header  = None)
df = data_q
...
plt.xlim(1, 100)
plt.ylim(0, 1.01)
plt.ylabel('Estimated Ancestry', fontsize = 18)
plt.xticks([])
plt.tick_params(axis='y', labelsize=18)  # 'labelsize' passt die Schriftgröße der Y-Achse an
# Mtext-Äquivalent in Python
plt.text(25, -0.1, "Population 1", ha='center', fontsize = 18)
plt.text(75, -0.1, "Population 2", ha='center', fontsize = 18)
plt.text(43, -0.25, 'Individuals', fontsize = 18)
...
data_q =  "C:\\Users\\carol\\Downloads\\q_example_marker_bad.txt" # Filepath
data_p =  "C:\\Users\\carol\\Downloads\\p_good.txt" # Filepath
...
plt.plot(x_values, res_max_sorted, label='Res Max', color='darkred')
plt.plot(x_values, res_min_sorted, label='Res Min', color='lightcoral')
