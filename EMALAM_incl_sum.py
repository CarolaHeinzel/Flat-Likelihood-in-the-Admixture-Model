...
def correct_formatJ(data_p):
    ...
    for i in range(K):
        ...
        p_alle.append(p1)
    return p_alle
# If we also have markers with more than two alleles
pJ = correct_formatJ(pJ)
# If we only have bi-allelic markers
# pJ = 0
...
k_specific = 0
n_trials = 1 # Number of different initial values for the minimization function
